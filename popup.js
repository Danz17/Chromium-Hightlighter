...
function fillLiterals(){
    ...
    //document.getElementById("field_limitations").innerHTML = chrome.i18n.getMessage("field_limitations");
    //document.getElementById("setLimits").innerHTML = chrome.i18n.getMessage("field_sitesToHighlight");
    //document.getElementById("backToFirstScreen").innerHTML = chrome.i18n.getMessage("popup_back");
